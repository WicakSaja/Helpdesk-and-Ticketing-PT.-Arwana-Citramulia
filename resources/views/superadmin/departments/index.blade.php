...
@section('content')
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        ...
        <button class="btn-add" onclick="openModal()" style="background: #1565c0; color: white; padding: 12px 25px; border-radius: 10px; font-weight: 600; border: none; cursor: pointer; display: flex; align-items: center; gap: 8px;">
            <i class="fa-solid fa-plus"></i> Tambah Baru
        </button>
    </div>

    <div class="table-container" style="background: white; padding: 25px; border-radius: 16px; box-shadow: 0 5px 20px rgba(0,0,0,0.03);">
        <table class="dept-table" style="width: 100%; border-collapse: separate; border-spacing: 0;">
            <thead>
                <tr>
                    ...
                    <th style="text-align: left; padding: 15px; border-bottom: 2px solid #f0f0f0; color: #888;">Nama Departemen</th>
            ...
            <tbody>
                ...
                <tr id="row-{{ $dept['id'] }}">
                    ...
                    <td style="padding: 15px; border-bottom: 1px solid #f9f9f9;"><strong>{{ $dept['name'] }}</strong></td>
                ...
                @empty
                <tr>
                    <td colspan="3" style="text-align: center; padding: 30px; color: #999;">Belum ada data departemen.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div id="deptModal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); display: none; align-items: center; justify-content: center; z-index: 1000;">
        <div style="background: white; width: 450px; padding: 30px; border-radius: 16px; box-shadow: 0 25px 50px rgba(0,0,0,0.2);">
            ...
            <form onsubmit="handleSave(event)">
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-size: 13px; font-weight: 600; color: #444; margin-bottom: 5px;">Nama Departemen</label>
                    <input type="text" id="deptName" required placeholder="Contoh: Information Technology" 
                ...
                <div style="text-align: right;">
                    ...
                    <button type="submit" id="btnSave" style="background: #1565c0; color: white; border: none; padding: 10px 25px; border-radius: 8px; cursor: pointer; font-weight: 600;">Simpan</button>
                </div>
            </form>
        </div>
    </div>
        ...
        try {
            ...
            if (response.ok) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Data departemen tersimpan!',
                    timer: 1000,
